...
- 표준 빌트인 객체에는 다양한 정적 메서드를 가진다.
  ...
  - 📌 *정적 메서드는 애플리케이션 전역에서 사용할 유틸리티 함수를 전역 함수로 정의하지 않고 메서드로 구조화할 때 유용하다.*
   ...
   <div markdown="1">
     - ES6에선 빌트인 전역 함수인 (<code>isFinite</code>, <code>isNaN</code> 등)의 빌트인 전역 함수[21.4.2절 참고](https://github.com/FE-FOREVER/JS-STUDY/blob/main/21.%20%EB%B9%8C%ED%8A%B8%EC%9D%B8%20%EA%B0%9D%EC%B2%B4/%EC%A1%B0%EB%AF%BC%EC%A7%80.md#2142-%EB%B9%8C%ED%8A%B8%EC%9D%B8-%EC%A0%84%EC%97%AD-%ED%95%A8%EC%88%98)를 표준 빌트인 객체 <code>Number</code>의 정적 메서드로 추가 구현했다.
    <br/>
