...
![딥다이브19-1](https://github.com/user-attachments/assets/492cefa9-3eb1-4cb3-8e60-ed5355231b12)
...
![딥다이브19-2](https://github.com/user-attachments/assets/ae7d2c2b-a2f5-4521-9cc8-6f9317aaf323)
...
- ✅ 모든 객체는 하나의 프로토타입을 가짐
  - 모든 프로토타입은 생성자 함수와 연결 ⇒ 객체와 프로토타입과 생성자 함수는 서로 연결
    ![딥다이브19-3](https://github.com/user-attachments/assets/ac681c5f-23e4-4a97-9d44-efa2cd5fa88f)
...
<img width="384" alt="딥다이브19-4" src="https://github.com/user-attachments/assets/b8426ec6-9755-413f-8850-540a77fb35b2" />
...
<img width="371" alt="딥다이브19-5" src="https://github.com/user-attachments/assets/d0e2ec71-eb37-4542-ad35-fb59b013db12" />
...
- 위 예제는 parent 객체를 child 객체의 프로토타입으로 설정 후, child 객체를 parent 객체의 프로토타입으로 설정했다.
  - 이 경우 서로가 자신의 프로토타입이 되는 비정상적인 프토토타입 체인이 발생할 수 있다. ⇒ **proto** 접근자 프로퍼티가 에러를 발생시키면서 방지
    ![딥다이브19-6](https://github.com/user-attachments/assets/39736af9-71f8-4cc2-86a8-cccc93886ec8)
...
![딥다이브19-7](https://github.com/user-attachments/assets/cba7fad7-f4db-4486-97a7-9cf8fef9f909)
...
![딥다이브19-8](https://github.com/user-attachments/assets/ca08fc49-6dff-4537-bbc3-9f1bf6b0acaa)
...
![딥다이브19-9](https://github.com/user-attachments/assets/85a1db2e-5e56-421c-9e4a-180ae54b0534)
...
![딥다이브19-10](https://github.com/user-attachments/assets/4370ee45-5520-412b-85ef-6544ae23f8d1)
...
<img width="320" alt="딥다이브19-11" src="https://github.com/user-attachments/assets/568a422e-ea01-4f89-a020-59a34bc729ae" />
...
![딥다이브19-12](https://github.com/user-attachments/assets/80f62186-6d5a-450c-ab2c-4279dc2731bb)
...
![딥다이브19-13](https://github.com/user-attachments/assets/be9e8d23-2caa-4355-8ab3-208303f1c859)
...
- `const obj = { x: 1 };` 의 객체 리터럴이 평가될 때
  ...
  - 추상 연산 `OrdinaryObjectCreate` 에 의해 Object 생성자 함수와 `Object.prototype` 과 생성된 객체 사이에 연결이 만들어짐
    ![딥다이브19-14](https://github.com/user-attachments/assets/c949a284-558d-4864-9840-41d8d72f5463)
...
![딥다이브19-15](https://github.com/user-attachments/assets/05c60f89-e057-4e85-b630-cdfbb5819e37)
...
![딥다이브19-16](https://github.com/user-attachments/assets/fed87bd2-17da-4aa6-bc55-13f6a0052ea0)
...
- Person.prototype의 프로토타입은 Object.prototype
  ...
  ```
![딥다이브19-18](https://github.com/user-attachments/assets/fb5e3bba-ed10-4697-b317-9c85c00ac717)
...
![딥다이브19-19](https://github.com/user-attachments/assets/c95d0571-0182-4260-95eb-83e5934d9b59)
...
![딥다이브19-20](https://github.com/user-attachments/assets/eb62fd8e-6509-4e13-a1a1-984951c5820e)
...
- 생성자 함수의 prototype 프로퍼티에 다른 임의의 객체를 바인딩하는 것 ⇒ ***미래에 생성할 인스턴스***의 프로토타입을 교체하는 것이다.
- **proto** 접근자 프로퍼티를 통해 프로토타입을 교체하는 것 ⇒ ***이미 생성된 객체***의 프로토타입을 교체하는 것
...
![딥다이브19-21](https://github.com/user-attachments/assets/c92de829-9493-446a-8958-dc65853f83f3)
...
![딥다이브19-22](https://github.com/user-attachments/assets/2f8bef8e-1a94-4fe2-a52f-cc04d144eee3)
...
![딥다이브19-23](https://github.com/user-attachments/assets/878d1234-7483-4df8-a1cf-e4051d0990c7)
...
![딥다이브19-24](https://github.com/user-attachments/assets/51a1b8f1-11f5-48ca-ad94-545bb576c72e)
...
![딥다이브19-25](https://github.com/user-attachments/assets/4c9c4ed6-14dd-41d3-860a-72c76d122088)
